 ...
 * Design Tokens
 *
 * Foundational design values for the Math Tutoring App design system.
...
export const colors = {
  // Primary - Blue palette (main brand color) - Refined for better polish
  primary: {
    lightest: "#e8f4fd",
    lighter: "#c3e4fb",
    light: "#9dd3f8",
    lightBase: "#6ebef5",
    mediumLight: "#4aaff2",
    base: "#2563eb", // More refined blue - slightly deeper and more modern
    mediumDark: "#1d4ed8",
    dark: "#1e40af",
    darker: "#1e3a8a",
    darkest: "#172554",
